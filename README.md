...
At a certain point you may wish to post maps of the distribution of COVID-19, whether by county or by zip code within particular states.  Ideally you'd like it to be html files, it ought to allow you to hover your mouse over the county and get additional information.  It may seem like an easy task.  After all, there are many attractive mapping programs available on the Internet, some are "free", there are a few examples for each of the features you might wish to make use of, maybe you're thinking, "I should have something up by next week".  
