...
There are two requirements to consider here:  1. the input (shapefiles, labels, novel coronavirus data), and 2. the output (file consisting of html code, scripts, and svg code). 
